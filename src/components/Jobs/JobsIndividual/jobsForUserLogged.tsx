...
import type { IJob } from "@/services/hooks/Jobs/useAllJobsForUserLogged";
...
export function JobsForUser() {
    ...
    if(!data?.jobs || data.jobs.length === 0){
       return (
    <VStack align="center" py={12}>
        <HStack align="flex-start" spacing={4} bg={useColorModeValue("blue.50", "blue.900")} p={4} borderRadius="md">
            <Icon as={FiSmile} w={8} h={8} color="blue.400"/>
            <VStack align="flex-start">
                <Text color={useColorModeValue("gray.700", "gray.300")} fontSize="lg" lineHeight="tall">
                    Não encontramos vagas específicas para seu perfil no momento,
                    mas temos muitas oportunidades incríveis esperando por você! ✨
                </Text>
                <Text color={useColorModeValue("gray.600", "gray.400")} fontSize="lg" lineHeight="tall">
                    Explore <b>Todas as Vagas</b> e encontre o que procura. 😊
                </Text>
            </VStack>
        </HStack>
    </VStack>
                                ...
                                <Flex>
                                    <Flex flex="1" gap="3" alignItems="center">
                                        ...
                                        <Box>
                                            ...
                                            <Text fontSize="11" color={useColorModeValue("gray.600", "gray.400")}>
