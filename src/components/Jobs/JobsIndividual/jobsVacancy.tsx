import { 
  ...
  Spinner, Grid, useBreakpointValue, HStack,
  FormControl,
  FormLabel,
  Input,
  FormErrorMessage,
...
import type { IJobs } from "@/services/hooks/Jobs/useJobsVacancy";
...
export function JobsVacancy({vacancy}: IJobsVacancyProps) {
    ...
    const { data: myApplications } = useMyApplicationsCandidate(userId, { enabled: !!userId });
