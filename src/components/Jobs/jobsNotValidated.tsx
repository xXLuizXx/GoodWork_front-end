import { Avatar, Box, Button, Card, CardBody, CardFooter, CardHeader, Flex, Heading, IconButton, Image, SimpleGrid, Text, VStack, useDisclosure, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Stack, Alert, AlertIcon, CheckboxIcon } from "@chakra-ui/react";
...
export function JobsNotValidated() {
    const {data} = useJobsNotValidated();
                    ...
                    >
                        ...
                        >
                            <SimpleGrid
                                ...
                                minChildWidth="90px"
                            >
                                <Button variant="ghost" leftIcon={<GoCheckCircleFill color="green"/>} size='xs'>Aprovar Vaga</Button>
                                <Button variant="ghost" leftIcon={<GoXCircleFill color="red"/>} size='xs'>Reprovar Vaga</Button>
