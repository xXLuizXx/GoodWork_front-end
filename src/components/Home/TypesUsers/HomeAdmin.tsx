...
import { FiUsers, FiTag, FiBriefcase, FiBarChart2 } from 'react-icons/fi';
...
export function HomeAdmin(): JSX.Element {
    ...
    const cards: CardItem[] = [
        { title: 'Usuários',   borderColor: 'blue', route: 'users/generate-users',          icon: FiUsers },
        { title: 'Categorias', borderColor: 'blue', route: 'categories/generate-categories', icon: FiTag },
        { title: 'Vagas',      borderColor: 'blue', route: '/jobs/generate-jobs',            icon: FiBriefcase },
